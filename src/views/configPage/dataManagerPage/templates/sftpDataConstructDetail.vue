...
<script src="../js/sftpDataConstructDetail.js"></script>
<template>
  <Box class="content-box" style="margin-top: -10px;">
    <div v-loading="regionLoading">
      ...
      <div style="float: left;left: auto">
        ...
        <label v-if="optType === 'watchDetail'" style="font-size: 10px"> 最新版本{{ serverInfo.version }},当前版本{{
          sftpSereverForm.version }}</label>
      </div>
      <div style="float: right;">
        <el-button type="warning" icon="el-icon-search" @click="showHistoryVerion">历史版本</el-button>
        <el-button
          v-if="serverInfo.version===sftpSereverForm.version"
          v-show="!submitFlag"
          type="success"
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="文件路径:">
                <el-input
                  v-model="sftpSereverForm.file_path"
                  class="inputClass"
                  :disabled="!submitFlag"
                  placeholder="请输入接口代码"
                />
            ...
            <el-col :span="12">
              <el-form-item label="文件名:">
                <el-input
                  v-model="sftpSereverForm.file_name"
                  class="inputClass"
                  :disabled="!submitFlag"
                  placeholder="请输入对象名"
                />
      ...
      <div>
        <el-form>
          <el-form-item label="文件说明">
            <el-input
              v-model="sftpSereverForm.interface_name"
              :disabled="!submitFlag"
        ...
        <el-form>
          <el-form-item label="文件类型:">
            <el-select v-model="bodyTypeFlag" :disabled="!submitFlag" placeholder="请选择文件类型">
              <el-option
      ...
      <div v-loading="loading" class="bodyRequest">
        ...
        <div v-if="bodyTypeFlag!='Other'&&bodyTypeFlag!='Text'">
        ...
        <div v-if="bodyTypeFlag=='Text'">
          <el-form label-width="500">
            <el-form-item>
              <el-input v-model="sftpTextBody" type="textarea" placeholder="请输入项目介绍" />
            </el-form-item>
          </el-form>
        </div>
      </div>
    ...
    <el-dialog title="确认提交" :visible.sync="versionDialog" width="30%" :show-close="false">
      <div style="margin-top: 20px">
        <el-form :model="sftpSereverForm">
          <el-form-item label="版本:   设置版本号:">
            <el-input v-model="sftpSereverForm.version" placeholder="设置版本号" />
          </el-form-item>
        </el-form>
        <el-form>
          <el-form-item label="说明:">
            <el-input v-model="sftpSereverForm.description" type="textarea" placeholder="请输入内容" />
          </el-form-item>
        </el-form>
      </div>
      <div slot="footer" class="dialog-footer">
      ...
      <div style="margin-top: 20px">
        <el-form :model="sftpSereverForm">
          <el-form-item label="版本:   设置版本号为v:">
            <el-input v-model="sftpSereverForm.version" placeholder="设置版本号为v" />
          </el-form-item>
          <el-form-item label="说明:">
            <el-input v-model="sftpSereverForm.description" type="textarea" placeholder="请输入内容" />
          </el-form-item>
