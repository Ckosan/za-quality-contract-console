        ...
        <div style="display: inline-block;width: 100%;">
          <div style="float: left">
            <label style="font-weight: bold;font-size: 20px">
              文档信息<label v-if="optType === 'watchDetail'" style="font-size: small;color: #888888;">（当前版本：{{
                httpSereverForm.version }}<span>，最新版本：{{ httpInfo.version }}</span>）
              </label>
            </label>
          </div>
              ...
              <div style="display: inline-block;display-inside: ruby;width: 100%;">
                <div style="float: left;width: 100%;">
                  ...
                  <div style="float: left;margin-left: 20px;">
                    ...
                    <label v-if="searchCount!='0'" style="font-weight: normal;font-size: 14px">共查到 <label
                      style="color: #ff0f20"
                  ...
                  <div style="float: left;width: 100%;">
                    ...
                    <div style="float: left;margin-left: 20px">
                      <el-input
                        ...
                        @input="seachBodyData"
                      ><i slot="prefix" class="el-input__icon el-icon-search" /></el-input>
                      <label v-if="searchCount!='0'" style="font-weight: normal;font-size: 14px">搜索结果共有 <label
                        style="color: #ff0f20"
                      >{{ searchCount }}</label> 处</label>
                    </div>
                    <div style="float: right;margin-left: 60px;">
